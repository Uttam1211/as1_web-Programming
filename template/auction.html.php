...
<nav><ul class='main_menu'>
			<?php include_once __DIR__.'/../public/category.php'; ?>
		</ul>
		</nav>
...
<img src="banners/1.jpg" alt="Banner" />
	...
	<main>
		...
		<ul class="productList">
				<?php 
				include_once __DIR__.'/../public/auction.php';
		...
		<article class="product">
			...
			<section class="reviews">
				...
				<ul>
					<li><strong>Ali said </strong> great ibuyer! Product as advertised and delivery was quick
						<em>29/09/2019</em>
					</li>
					<li><strong>Dave said </strong> disappointing, product was slightly damaged and arrived
						slowly.<em>22/07/2019</em></li>
